...
void on_buttonAuthentification_clicked (GtkWidget *obj, gpointer user_data)
{
	...
	case 2:
		...
		gtk_container_add(GTK_CONTAINER(windowopen),GTK_WIDGET(table3));
		image3=create_pixmap(windowopen,"./index.jpeg");
		image3=gtk_image_new_from_file("./index.jpeg");
		gtk_table_attach_defaults(GTK_TABLE(table3),image3,0,0,0,0);

		
		table4=gtk_table_new(0,0,TRUE);
		gtk_container_add(GTK_CONTAINER(windowopen),GTK_WIDGET(table4));
		image4=create_pixmap(windowopen,"./change.jpg");
		image4=gtk_image_new_from_file("./change.jpg");
		gtk_table_attach_defaults(GTK_TABLE(table4),image4,0,0,0,0);
	...
	case 4:
		window2 = lookup_widget(obj,"windowAuthenti");
		window9 = lookup_widget(obj,"window9");
	...
	/*case 5:
		window2 = lookup_widget(obj,"windowAuthenti");
		window11 = lookup_widget(obj,"window11");
...
//gestion des cilents
void
on_button14_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;

	window1=lookup_widget(obj,"window1");
	window2=lookup_widget(obj,"window11");


	gtk_widget_destroy(window1);
	window2=create_window11();
	gtk_widget_show(window2);
}
...
void
on_button15_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
	f=fopen("recla.txt","w");
	...
	window1=lookup_widget(obj,"window1");
	window2=lookup_widget(obj,"window17");

	window2=create_window17();
	gtk_widget_destroy(window1);	
	gtk_widget_show(window2); 	
}
                                        ...
                                        gpointer         user_data)
{
	...
	/*label1=lookup_widget(obj, "label450");
	label2=lookup_widget(obj, "label451");
	label3=lookup_widget(obj, "label452");
	label4=lookup_widget(obj, "label453");
	label5=lookup_widget(obj, "label454");
	label6=lookup_widget(obj, "label455");*/
	...
	/*if (strcmp(agen.cin,"")==0) gtk_label_set_text(GTK_LABEL(label1),"cin non valide");
	else gtk_label_set_text(GTK_LABEL(label1),"✔");
	if (strcmp(agen.nom,"")==0) gtk_label_set_text(GTK_LABEL(label2),"nom non valide");
	else gtk_label_set_text(GTK_LABEL(label2),"✔");
	if (strcmp(agen.prenom,"")==0) gtk_label_set_text(GTK_LABEL(label3),"prenom non valide");
	else gtk_label_set_text(GTK_LABEL(label3),"✔");
	if (strcmp(agen.sex,gtk_combo_box_get_active_text(GTK_COMBO_BOX(combobox2)))==0) gtk_label_set_text(GTK_LABEL(label4),"✔");
	else gtk_label_set_text(GTK_LABEL(label4),"sex non valide");
	if (strcmp(agen.login,"")==0) gtk_label_set_text(GTK_LABEL(label5),"login non valide");
	else gtk_label_set_text(GTK_LABEL(label5),"✔");
	if (strcmp(agen.mot_de_passe,"")==0) gtk_label_set_text(GTK_LABEL(label6),"nom non valide");
	else gtk_label_set_text(GTK_LABEL(label6),"✔");*/
		...
		if(f!=NULL){
			while(fscanf(f,"%s\n",test)!=EOF){
				...
				if (strcmp(test,"1")==0){
					...
					window1=lookup_widget(obj,"window8");
					window2=lookup_widget(obj,"window9");
...
void
on_button41_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window9=lookup_widget(obj,"window9");
	window10=lookup_widget(obj,"window10");
...
//recherche reservation vol
void
on_button42_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window1 = lookup_widget(obj,"window10");

	window2 = lookup_widget(obj,"windowCatamogue");
	window2=create_windowCatamogue();	
	gtk_widget_show(window2);	
	
	treeview1=lookup_widget(window2,"treeview12Prestation2");
	afficherPrestations(treeview1);
...
//confirmation reservation vol
void
on_button43_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *combo;
	...
	entry1=lookup_widget(obj,"entry75");
	entry2=lookup_widget(obj,"entry76");
	entry3=lookup_widget(obj,"entry78");
	entry4=lookup_widget(obj,"entry77");

	combo=lookup_widget(obj,"combobox5");

	spin1=lookup_widget(obj,"spinbutton17");
	spin2=lookup_widget(obj,"spinbutton18");
	spin3=lookup_widget(obj,"spinbutton19");
	spin4=lookup_widget(obj,"spinbutton20");
	spin5=lookup_widget(obj,"spinbutton21");
	spin6=lookup_widget(obj,"spinbutton22");

	
	strcpy(a.type,gtk_combo_box_get_active_text(GTK_COMBO_BOX(combo)));

	strcpy(a.v_depart,gtk_entry_get_text(GTK_ENTRY(entry1)));
	strcpy(a.v_arr,gtk_entry_get_text(GTK_ENTRY(entry2)));
	strcpy(a.idc,gtk_entry_get_text(GTK_ENTRY(entry3)));
	strcpy(a.idr,gtk_entry_get_text(GTK_ENTRY(entry4)));

	a.bebe=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spin1));
	a.enf=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spin2));
	a.adult=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spin3));
	a.dt_res.jour=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spin4));
	a.dt_res.mois=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spin5));
	a.dt_res.annee=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spin6));
...
//modification reservation vol
void
on_button64_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	char id1[50];
	char client1[50];
	...
	entry1=lookup_widget(obj,"entry80");
		strcpy(id1,gtk_entry_get_text(GTK_ENTRY(entry1)));

	entry2=lookup_widget(obj,"entry81");
		strcpy(client1,gtk_entry_get_text(GTK_ENTRY(entry2)));

	entry3=lookup_widget(obj,"entry82");
		strcpy(type1,gtk_entry_get_text(GTK_ENTRY(entry3)));

	entry4=lookup_widget(obj,"entry83");
		strcpy(depart1,gtk_entry_get_text(GTK_ENTRY(entry4)));

	entry5=lookup_widget(obj,"entry84");
		strcpy(arrivee1,gtk_entry_get_text(GTK_ENTRY(entry5)));

	entry6=lookup_widget(obj,"entry85");
		strcpy(passager1,gtk_entry_get_text(GTK_ENTRY(entry6)));

	entry7=lookup_widget(obj,"entry86");
		strcpy(date1,gtk_entry_get_text(GTK_ENTRY(entry7)));

	modifierResVol(id1,client1,type1,depart1,arrivee1,passager1,date1);
}

//retour accueil reservation
void
on_button66_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
...
//déconnexion espace reservation
void
on_button65_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window9=lookup_widget(obj,"window9");
	window1=lookup_widget(obj,"windowAccueil");
                                        ...
                                        gpointer         user_data)
{
	...
	strcpy(reservation,gtk_combo_box_get_active_text(GTK_COMBO_BOX(combobox1)));	

	if(strcmp("Vols",reservation)==0){
		window1 = lookup_widget(obj,"window9");
		window2 = lookup_widget(obj,"window9");

		window1=create_window9();
		gtk_widget_destroy(window2);
		gtk_widget_show(window1);

		treeview4 = lookup_widget(window1,"treeview4");

		afficherreservation(treeview4);
	}
	else{
		window1 = lookup_widget(obj,"window9");
		window2 = lookup_widget(obj,"window9");
		...
		afficherreservationHbr(treeview4);
	}
}


//recherche modification d'une reservation pour le vol
void
on_button44_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
	char id[50];
	...
	entry8=lookup_widget(obj,"entry79");

	strcpy(id1,gtk_entry_get_text(GTK_ENTRY(entry8)));
	...
	if (f!=NULL)
  	{
			...
			if(strcmp(id1,id)==0){
				...
				gtk_entry_set_text(GTK_ENTRY(entry1),id);
				gtk_entry_set_text(GTK_ENTRY(entry2),client);
				gtk_entry_set_text(GTK_ENTRY(entry3),type);
				gtk_entry_set_text(GTK_ENTRY(entry4),depart);
				gtk_entry_set_text(GTK_ENTRY(entry5),arrivee);
				gtk_entry_set_text(GTK_ENTRY(entry6),passager);
				gtk_entry_set_text(GTK_ENTRY(entry7),date);
			}
                                        ...
                                        gpointer         user_data)
{
		...
		entry1=lookup_widget(obj,"entry92");
		strcpy(identifiant,gtk_entry_get_text(GTK_ENTRY(entry1)));
		
		supprimReserVol(identifiant);
}


void
on_button48_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	Reserve h;
	...
	entry2=lookup_widget(obj,"entry93");
	entry3=lookup_widget(obj,"entry94");
	entry4=lookup_widget(obj,"entry95");

	combobox1=lookup_widget(obj,"combobox6");

	spinbutton1=lookup_widget(obj,"spinbutton28");
	spinbutton2=lookup_widget(obj,"spinbutton23");
	spinbutton3=lookup_widget(obj,"spinbutton24");
	spinbutton4=lookup_widget(obj,"spinbutton25");
	spinbutton5=lookup_widget(obj,"spinbutton26");
	spinbutton6=lookup_widget(obj,"spinbutton27");

	
	strcpy(h.type,gtk_combo_box_get_active_text(GTK_COMBO_BOX(combobox1)));

	strcpy(h.idc,gtk_entry_get_text(GTK_ENTRY(entry3)));
	strcpy(h.idr,gtk_entry_get_text(GTK_ENTRY(entry4)));
	strcpy(h.ville,gtk_entry_get_text(GTK_ENTRY(entry2)));

	h.bebe=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton1));
	h.enf=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton2));
	h.adult=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton3));
	h.dt_ent.jour=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton4));
	h.dt_ent.mois=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton5));
	h.dt_ent.annee=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton6));
	
	ReservationHbr(h);
}

//recherche modification reservation Hbr
void
on_button50_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
	char id[50];
	...
	entry7=lookup_widget(obj,"entry99");

	strcpy(id1,gtk_entry_get_text(GTK_ENTRY(entry7)));
	...
	if (f!=NULL)
  	{
			...
			if(strcmp(id1,id)==0){
				...
				entry1=lookup_widget(obj,"entry119");
				entry2=lookup_widget(obj,"entry97");
				entry3=lookup_widget(obj,"entry98");
				entry4=lookup_widget(obj,"entry96");
				entry5=lookup_widget(obj,"entry117");
				entry6=lookup_widget(obj,"entry118");

				gtk_entry_set_text(GTK_ENTRY(entry1),id);
				gtk_entry_set_text(GTK_ENTRY(entry2),client);
				gtk_entry_set_text(GTK_ENTRY(entry3),ville);
				gtk_entry_set_text(GTK_ENTRY(entry4),type);
				gtk_entry_set_text(GTK_ENTRY(entry5),personne);
				gtk_entry_set_text(GTK_ENTRY(entry6),date);
			}
...
//modification reservation Hbr
void
on_button51_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	char id1[50];
	char client1[50];
	...
	entry4=lookup_widget(obj,"entry96");
		strcpy(type1,gtk_entry_get_text(GTK_ENTRY(entry4)));

	entry5=lookup_widget(obj,"entry117");
		strcpy(personne1,gtk_entry_get_text(GTK_ENTRY(entry5)));

	entry6=lookup_widget(obj,"entry118");
		strcpy(date1,gtk_entry_get_text(GTK_ENTRY(entry6)));


	 modifierResHbr(id1,client1,ville1,type1,personne1,date1);
}

void
on_button52_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	char id[50];

	entry1=lookup_widget(obj,"entry100");
	strcpy(id,gtk_entry_get_text(GTK_ENTRY(entry1)));
...
void
on_button49_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window1 = lookup_widget(obj,"window10");
	...
	treeview1=lookup_widget(window2,"treeview12Prestation2");
	afficherPrestationHbr(treeview1);
}


//accès ajout client
void
on_button68_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{

	GtkWidget *window1, *window2;

	window1=lookup_widget(obj,"window11");
	window2=lookup_widget(obj,"window12");


	gtk_widget_destroy(window1);
	window2=create_window12();
	gtk_widget_show(window2);
...
//ajout client
void
on_button71_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
Personne p;
...
fenetre_ajout=lookup_widget(obj,"window12");
*/
input1=lookup_widget(obj,"entry120");
input2=lookup_widget(obj,"entry121");
input3=lookup_widget(obj,"entry122");
input4=lookup_widget(obj,"entry123");
input5=lookup_widget(obj,"entry124");
input6=lookup_widget(obj,"entry126");
input7=lookup_widget(obj,"entry127");
input8=lookup_widget(obj,"entry125");
...
//retour page gestion client
void
on_button72_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;

	window1=lookup_widget(obj,"window12");
	window2=lookup_widget(obj,"window11");
...
//connexion client
void
on_buttonInscritClient_clicked         (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;
...
void
on_button69_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window1;
...
window1=lookup_widget(obj,"window11");
fenetre_afficher=lookup_widget(obj,"window13");

gtk_widget_destroy(window1);
fenetre_afficher=create_window13();
gtk_widget_show(fenetre_afficher);
      

treeview1=lookup_widget(fenetre_afficher,"treeview13");
...
//retour page gestion client
void
on_button73_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;

	window1=lookup_widget(obj,"window13");
	window2=lookup_widget(obj,"window11");
...
//Accès modification
void
on_button67_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	/*GtkWidget *window2, *window1;

	window1=lookup_widget(obj,"window11");
	window2=lookup_widget(obj,"window14");
...
//retour page gestion modification
void
on_button75_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;
...
void
on_button76_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
	char cin[30];
	...
	entry9=lookup_widget(obj,"entry136");

	strcpy(cin1,gtk_entry_get_text(GTK_ENTRY(entry9)));

	if (f!=NULL)
  	{
    		while(fscanf(f,"%s %s %s %s %s %s %s %s\n",cin,nom,prenom,naissance,adresse,mail,pays,pass)!=EOF){
			if(strcmp(cin1,cin)==0){

				entry1=lookup_widget(obj,"entry133");
				entry2=lookup_widget(obj,"entry137");
				entry3=lookup_widget(obj,"entry129");
				entry4=lookup_widget(obj,"entry135");
				entry5=lookup_widget(obj,"entry132");
				entry6=lookup_widget(obj,"entry131");
				entry7=lookup_widget(obj,"entry130");
				entry8=lookup_widget(obj,"entry134");

				gtk_entry_set_text(GTK_ENTRY(entry1),cin);
				gtk_entry_set_text(GTK_ENTRY(entry2),nom);
				gtk_entry_set_text(GTK_ENTRY(entry3),prenom);
				gtk_entry_set_text(GTK_ENTRY(entry4),naissance);
				gtk_entry_set_text(GTK_ENTRY(entry5),adresse);
				gtk_entry_set_text(GTK_ENTRY(entry6),mail);
				gtk_entry_set_text(GTK_ENTRY(entry7),pays);
				gtk_entry_set_text(GTK_ENTRY(entry8),pass);
			}
...
void
on_button74_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	//Personne p;	
	...
	entry1=lookup_widget(obj,"entry133");
		strcpy(cin1,gtk_entry_get_text(GTK_ENTRY(entry1)));

	entry2=lookup_widget(obj,"entry137");
		strcpy(nom1,gtk_entry_get_text(GTK_ENTRY(entry2)));

	entry3=lookup_widget(obj,"entry129");
		strcpy(prenom1,gtk_entry_get_text(GTK_ENTRY(entry3)));

	entry4=lookup_widget(obj,"entry135");
		strcpy(naissance1,gtk_entry_get_text(GTK_ENTRY(entry4)));

	entry5=lookup_widget(obj,"entry132");
		strcpy(adresse1,gtk_entry_get_text(GTK_ENTRY(entry5)));

	entry6=lookup_widget(obj,"entry131");
		strcpy(mail1,gtk_entry_get_text(GTK_ENTRY(entry6)));

	entry7=lookup_widget(obj,"entry130");
		strcpy(pays1,gtk_entry_get_text(GTK_ENTRY(entry7)));

	entry8=lookup_widget(obj,"entry134");
		strcpy(pass1,gtk_entry_get_text(GTK_ENTRY(entry8)));


	//modifier(p);
	 modifier(cin1,nom1,prenom1,naissance1,adresse1,mail1,pays1,pass1);*/
}


void
on_button70_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;

	window1=lookup_widget(obj,"window11");
	window2=lookup_widget(obj,"window15");


	gtk_widget_destroy(window1);
	window2=create_window15();
	gtk_widget_show(window2);
}


void
on_button78_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	GtkWidget *window2, *window1;
	...
	gtk_widget_destroy(window2);
	window1=create_window11();
	gtk_widget_show(window1);
}


void
on_button77_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
		GtkWidget *input1;
		char cinn[30];
		...
		input1 = lookup_widget(obj,"entry138");
		strcpy(cinn,gtk_entry_get_text(GTK_ENTRY(input1)));
		supprimer(cinn);
}

//accès page réclamation
void
on_button79_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
	f=fopen("recla.txt","w");
	...
	window1=lookup_widget(obj,"window9");
	window2=lookup_widget(obj,"window16");


	gtk_widget_destroy(window1);
	window2=create_window16();
	gtk_widget_show(window2);
...
void
on_button81_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
GtkWidget *entry1;
GtkWidget *combobox;
...
spinbutton1=lookup_widget(obj,"spinbutton55");
spinbutton2=lookup_widget(obj,"spinbutton56");
spinbutton3=lookup_widget(obj,"spinbutton57");
combobox=lookup_widget(obj,"combobox9");
entry1=lookup_widget(obj,"entry139");

strcpy(r.reclamation,gtk_entry_get_text(GTK_ENTRY(entry1)));
r.dt.jour=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton1));
r.dt.mois=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton2));
r.dt.annee=gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(spinbutton3));
strcpy(r.objet,gtk_combo_box_get_active_text(GTK_COMBO_BOX(combobox)));

reclamer(r);

window1=lookup_widget(obj,"window16");
window2=lookup_widget(obj,"window17");
...
void
on_button82_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window1=lookup_widget(obj,"window17");
	notebook1=lookup_widget(window1,"notebook12");
	treeview1=lookup_widget(notebook1,"treeview14");
...
void
on_button84_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
		char test[5];
...
void
on_button83_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window1=lookup_widget(obj,"window16");
	window2=lookup_widget(obj,"window17");
...
//retour window admin
void
on_button85_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	window1=lookup_widget(obj,"window1");
	window2=lookup_widget(obj,"window11");
...
void
on_button80_clicked                    (GtkWidget       *obj,
                                        gpointer         user_data)
{
	FILE *f;
	f=fopen("fact.txt","w");
